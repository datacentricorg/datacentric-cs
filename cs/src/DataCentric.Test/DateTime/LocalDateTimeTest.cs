...
namespace DataCentric.Test
{
    ...
    public class LocalDateTimeTest
    {
        ...
        public void Empty()
        {
            ...
            {
                var empty = new LocalDateTime();
                context.Log.Assert(empty == LocalDateTimeUtil.Empty, "empty == LocalDateTimeUtil.Empty");
        ...
        private void VerifyRoundtrip(Context context, LocalDateTime value)
        {
            ...
            LocalDateTime parsedStringValue = LocalDateTimeUtil.Parse(stringValue);
